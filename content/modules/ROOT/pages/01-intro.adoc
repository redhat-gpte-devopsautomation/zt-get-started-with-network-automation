...
. When we refer to the btn:[Controller], btn:[VSCode Editor] or btn:[>_Controller CLI] tabs, we mean the ones at the top bar. 
...
. Each "box" for playbooks and commands has a copy & paste feature, where if you click on the box, the content will be copied to the clipboard. You can paste this into the VSCode Editor if you run into problems typing.
